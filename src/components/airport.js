                        ...
                        <div className="side-navbar" id="side-navbar-color">
                            ...
                            <div className="menu mt-4">
                                ...
                                <ul className="list-iteams">
                                        ...
                                        <div className="row d-block">
                                            ...
                                            <div className="collapse" id="Admin-Portal-collapse" >
                                                <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                                    ...
                                                    <li><NavLink href="/captains" className="link-body-emphasis d-inline-flex text-decoration-none rounded">- Captains </NavLink></li>
                                    ...
                                    <li>
                                        <div className="row d-block">
                                            <button className="btn-3 btn-toggle d-inline-flex rounded border-0 collapsed Active" data-bs-toggle="collapse"
                                            ...
                                            <div className="collapse show" id="Airport-collapse" >
                                                <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                                    <li><NavLink href="/airport" className="link-body-emphasis d-inline-flex text-decoration-none rounded Active">- Airports</NavLink></li>
                            ...
                            <div className="row">
                                <div className="col-lg-5 col-md-4">
                                    <div className="left">
                                        ...
                                        <button type="button" className="modal-btn site-btn " data-bs-toggle="modal" data-bs-target="#exampleModal"
                                            ...
                                            <div className="modal-dialog">
                                                <div className="modal-content">
                                                    <div className="modal-header">
                                                        <h1 className="modal-title fs-5" id="exampleModalLabel">Add Info</h1>
                                                        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div className="modal-body">
                                                        <form>
                                                            <div className="mb-2">
                                                                <label for="recipient-name" className="col-form-label">AirportAddress</label>
                                                                <input type="text" className="form-control" id="AirportAddress-name" placeholder="AirportAddress" />
                                                            </div>

                                                            <div className="mb-2">
                                                                <label for="recipient-name" className="col-form-label">AirportCountry</label>
                                                                <input type="text" className="form-control" id="AirportCountry-name" placeholder="AirportCountry" />
                                                            </div>

                                                            <div className="mb-2">
                                                                <label for="recipient-name" className="col-form-label">AirportCounty</label>
                                                                <input type="text" className="form-control" id="AirportCounty-name" placeholder="AirportCounty" />
                                                            </div>

                                                            <div className="mb-2">
                                                                <label for="recipient-name" className="col-form-label">AirportState</label>
                                                                <input type="text" className="form-control" id="AirportState-name" placeholder="AirportState" />
                                                            </div>


                                                            <div className="mb-2">
                                                                <label for="recipient-name" className="col-form-label">AirportCity</label>
                                                                <input type="text" className="form-control" id="AirportCity-name" placeholder="AirportCity" />
                                                            </div>


                                                            <div className="mb-2">
                                                                <label for="recipient-name" className="col-form-label">AirportZipCode </label>
                                                                <input type="text" className="form-control" id="AirportZipCode-name" placeholder="AirportZipCode" />
                                                            </div>
                                                    ...
                                                    <div className="modal-footer">
                                                        ...
                                                        <button type="button" className="btn site-btn ">Send message</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="col-lg-7 col-md-8 col-12 p-0">
                                ...
                                <table className="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col"> AirportAddress </th>
                                            <th scope="col"> AirportCountry </th>
                                            <th scope="col"> AirportState </th>
                                            <th scope="col"> AirportCity</th>
                                            <th scope="col"> AirportZipCode</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Name</td>
                                            <td>Honda</td>
                                            <td>Honda is Link japanies brand</td>
                                            <td>Honda</td>
                                            <td>2024-06-10</td>
                                            <td>2024-06-10</td>
                                            <td className="d-flex">
                                                <button type="button" className="btn btn-primary py-3 me-2">Edit</button>
