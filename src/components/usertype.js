                    ...
                    <div className="row d-block">
                      ...
                      <div className="collapse show" id="User-Management-collapse">
                        <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                          ...
                          <li><a href="/usertype" className="link-body-emphasis d-inline-flex text-decoration-none rounded Active">- User Types</a></li>
                      ...
                      <div className="modal-dialog">
                        <div className="modal-content">
                          <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Add New User type</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                          </div>
                          <div className="modal-body">
                            <form>
                              <div className="mb-3">
                                <label for="txtMake" className="form-label">User type</label>
                                <input type="text" className="form-control" id="txtMake" placeholder="User type" />
                              </div>

                              <div className="mb-3">
                                <label for="txtMake" className="form-label">Is Detected</label>
                                <input type="text" className="form-control" id="txtMake" placeholder="Is Detected" />
                              </div>
