                                ...
                                <ul className="list-iteams">
                                    ...
                                    <li>
                                        <div className="row d-block">
                                            ...
                                            <div className="collapse show" id="User-Management-collapse">
                                                <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                                    <li><a href="/user" className="link-body-emphasis d-inline-flex text-decoration-none rounded Active">- Users</a></li>
                                            ...
                                            <div className="modal-dialog">
                                                <div className="modal-content">
                                                    ...
                                                    <div className="modal-body">
                                                        <form>
                                                            <div className="mb-3">
                                                                <label for="txtMake" className="form-label">First Name</label>
                                                                <input type="text" className="form-control" id="txtMake" placeholder="First Name" />
                                                            </div>

                                                            <div className="mb-3">
                                                                <label for="txtMake" className="form-label">Last Name</label>
                                                                <input type="text" className="form-control" id="txtMake" placeholder="Last Name" />
                                                            </div>

                                                            <div className="mb-3">
                                                                <label for="txtMake" className="form-label">User Name</label>
                                                                <input type="text" className="form-control" id="txtMake" placeholder="User Name" />
                                                            </div>
                                                            ...
                                                            <div className="mb-3">
                                                                <label for="txtMakeType" className="form-label">User Email</label>
                                                                <input type="text" className="form-control" id="txtMakeType" placeholder="User Email" />
                                                            </div>


                                                            <div className="mb-3">
                                                                <label for="txtMake" className="form-label">	Password</label>
                                                                <input type="password" className="form-control" id="txtMake" placeholder="Password" />
                                                            </div>
                                                        </form>
