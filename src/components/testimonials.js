                ...
                <ul class="list-iteams">
                  ...
                  <li>
                    <div class="row d-block">
                      ...
                      <div class="collapse show" id="Admin-Portal-collapse" >
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                          ...
                          <li><a href="/testimonials" class="link-body-emphasis d-inline-flex text-decoration-none rounded Active">- Testimonials</a></li>
                  ...
                  <li>
                    <div class="row d-block">
                      ...
                      <div class="collapse" id="User-Registration-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                          ...
                          <li><a href="/roles" class="link-body-emphasis d-inline-flex text-decoration-none rounded">- Roles</a></li>
                  ...
                  <li>
                    <div class="row d-block">
                      ...
                      <div class="collapse" id="Vehicle-Configuration-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                          <li><a href="/vehicledetails" class="link-body-emphasis d-inline-flex text-decoration-none rounded">- Vehicle Make</a></li>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form>
                              <div class="mb-3">
                                <label for="txtMake" class="form-label">Testimonial Name</label>
                                <input type="text" class="form-control" id="txtMake" placeholder="Testimonial Name" />
                              </div>
                              <div class="mb-3">
                                <label for="txtMakeType" class="form-label">Testimonial Value</label>
                                <input type="text" class="form-control" id="txtMakeType" placeholder="Testimonial Value" />
                              </div>
                            </form>
                          </div>
                ...
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Testimonials Name</th>
                      <th scope="col">Testimonials Value</th>
