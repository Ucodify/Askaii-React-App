              ...
              <div className="row d-block">
                ...
                <div className="collapse show" id="Bookings-collapse" >
                  <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    ...
                    <li><NavLink href="/cancelledbookings" className="link-body-emphasis d-inline-flex text-decoration-none rounded Active">- Cancelled Bookings</NavLink></li>
            ...
            <li>
              <div className="row d-block">
                ...
                <div className="collapse" id="User-Registration-collapse">
                  <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><NavLink href="/activebooking" className="link-body-emphasis d-inline-flex text-decoration-none rounded">- In Active Users</NavLink></li>
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title" id="exampleModalLabel">Add New Make</h5>
                  <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div className="modal-body">
                  <form>
                    <div className="mb-3">
                      <label for="txtMake" className="form-label">Vehicle Make</label>
                    ...
                    <div className="mb-3">
                      <label for="txtMakeType" className="form-label">Make Type</label>
                      <input type="text" className="form-control" id="txtMakeType" placeholder="Make Type" />
                    </div>
                  </form>
                </div>
