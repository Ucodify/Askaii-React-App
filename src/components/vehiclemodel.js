                    ...
                    <div className="row d-block">
                      ...
                      <div className="collapse show" id="Vehicle-Configuration-collapse">
                        <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                          ...
                          <li><a href="/vehiclemodel" className="link-body-emphasis d-inline-flex text-decoration-none rounded Active">- Vehicle Model</a></li>
            ...
            <div className="section-1">
              <div className="row">
                <div className="col-lg-4 col-md-4">
                  <div className="left">
                    <button type="button" className="btn site-btn" data-bs-toggle="modal" data-bs-target="#modalModel">
                      Add New Model
                    </button>
                    <div className="modal fade" id="modalModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div className="modal-dialog">
                        <div className="modal-content">
                          <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Add New Model</h5>
