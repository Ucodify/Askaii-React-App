                                        ...
                                        <div className="row d-block">
                                            ...
                                            <div className="collapse show" id="Admin-Portal-collapse" >
                                                <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                                    ...
                                                    <li><a href="/garage" className="link-body-emphasis d-inline-flex text-decoration-none rounded Active">- Garage</a></li>
                                            ...
                                            <div className="modal-dialog">
                                                <div className="modal-content">
                                                    <div className="modal-header">
                                                        <h5 className="modal-title" id="exampleModalLabel">Add New Garage</h5>
                                                        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div className="modal-body">
                                                        <form>
                                                            <div className="mb-3">
                                                                <label for="txtMake" className="form-label">Garage Name</label>
                                                                <input type="text" className="form-control" id="txtMake" placeholder="Garage Name" />
                                                            </div>
                                                            <div className="mb-3">
                                                                <label for="txtMakeType" className="form-label">Garage Number</label>
                                                                <input type="text" className="form-control" id="txtMakeType" placeholder="Garage Number" />
                                                            </div>
                                                            <div className="mb-3">
                                ...
                                <table className="table">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">Garage rate</th>
                                            <th scope="col">Garage total bookings</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
