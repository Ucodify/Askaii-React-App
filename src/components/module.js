                    ...
                    <div class="row d-block">
                      ...
                      <div class="collapse show" id="User-Registration-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                          ...
                          <li><a href="/module" class="link-body-emphasis d-inline-flex text-decoration-none rounded Active">- Modules</a></li>
                        </ul>
                      </div>
                    </div>
                  </li>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form>
                                <div class="mb-3">
                                  <label for="txtMake" class="form-label"> Module Name </label>
                                  <input type="text" class="form-control" id="txtMake" placeholder=" Module Name" />
                                </div>
                              </form>
                            </div>
