                    ...
                    <div className="row d-block">
                      ...
                      <div className="collapse show" id="Bookings-collapse" >
                        <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                          ...
                          <li><a href="/quotes" className="link-body-emphasis d-inline-flex text-decoration-none rounded Active">- Quotes</a></li>
                        </ul>
                      </div>
                    </div>
                  </li>
                      ...
                      <div className="modal-dialog">
                        <div className="modal-content ">
                          <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Add New Quote</h5>
                          ...
                          <div className="modal-body ">
                            <form>
                              ...
                              <div className="mb-3">
                                <label for="txtMake" className="form-label">Phone Number</label>
                                <input type="tel" className="form-control" id="txtMake" placeholder="Phone Number" />
                              </div>

                              <div className="mb-3">
                                <label for="txtMake" className="form-label">Customer Email</label>
                                <input type="email" className="form-control" id="txtMake" placeholder="Customer Email" />
                              </div>


                              <div className="mb-3">
                                <label for="txtMake" className="form-label">Quote Code</label>
                                <input type="text" className="form-control" id="txtMake" placeholder="Quote Code" />
                              </div>

                              <div className="mb-3">
                                <label for="txtMake" className="form-label">Start Date Time</label>
                                <input type="datetime-local" className="form-control" id="txtMake" placeholder="Start Date Time" />
                              </div>


                              <div className="mb-3">
                                <label for="txtMakeType" className="form-label">End Date Time</label>
                                <input type="datetime-local" className="form-control" id="txtMakeType" placeholder="End Date Time" />
                              </div>


                              <div className="mb-3">
                                <label for="txtMakeType" className="form-label">Total Cost</label>
                                <input type="number" className="form-control" id="txtMakeType" placeholder="Total Cost" />
                              </div>

                              <div className="mb-3">
                                <label for="txtMakeType" className="form-label">Airport Name</label>
                                <input type="text" className="form-control" id="txtMakeType" placeholder="Airport Name" />
                              </div>
                              ...
                              <div className="mb-3">
                                <label for="txtMakeType" className="form-label"> Inbound Flight Number</label>
                                <input type="number" className="form-control" id="txtMakeType" placeholder="Inbound Flight Number" />
                              </div>


                              <div className="mb-3">
                                <label for="txtMakeType" className="form-label">Outbound Flight Number </label>
                                <input type="text" className="form-control" id="txtMakeType" placeholder="Outbound Flight Number" />
                              </div>


                              <div className="mb-3">
                                <label for="txtMakeType" className="form-label"> Outbound Terminal ID</label>
                                <input type="text" className="form-control" id="txtMakeType" placeholder="Outbound Terminal ID" />
                              </div>


                              <div className="mb-3">
                                <label for="txtMakeType" className="form-label">Inbound Terminal ID</label>
                                <input type="text" className="form-control" id="txtMakeType" placeholder="Inbound Terminal ID" />
                              </div>
                ...
                <table className="table table-sm">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>876</td>
                      <td>
                        <button type="button" className="btn btn-primary font">Booking</button>
