                            ...
                            <ul className="list-iteams">
                                ...
                                <li>
                                    <div className="row d-block">
                                        ...
                                        <div className="collapse show" id="User-Registration-collapse">
                                            <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                                ...
                                                <li><NavLink href="/blockedusers" className="link-body-emphasis d-inline-flex text-decoration-none rounded Active">- Blocked Users</NavLink></li>
                            ...
                            <table className="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>2024-06-10</td>
                                        <td>
                                            <button type="button" className="btn btn-primary">Un-Block</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
