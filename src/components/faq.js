                    ...
                    <div className="row d-block">
                      ...
                      <div className="collapse show" id="Admin-Portal-collapse" >
                        <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                          ...
                          <li><a href="/faq" className="link-body-emphasis d-inline-flex text-decoration-none rounded Active">- FAQs</a></li>
                      ...
                      <div className="modal-dialog">
                        <div className="modal-content">
                          <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Add New Question</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                          </div>
                          <div className="modal-body">
                            <form>
                              <div className="mb-3">
                                <label for="txtMake" className="form-label">Question</label>
                                <input type="text" className="form-control" id="txtMake" placeholder="Enter here Question?" />
                              </div>

                              <div className="mb-3">
                                <label for="txtDescription" className="form-label">Answer</label>
              ...
              <div className="table-responsive">
                <table className="table">
                  ...
                  <tbody>
                    <tr>
                      <td>1</td>
                      <td>What are careers here?</td>
                      <td>Check career page</td>
                      <td>
                    ...
                    <tr>
                      <td>2</td>
                      <td>What is the price of Honda car?</td>
                      <td>5000000</td>
                      <td>
                        <button type="button" className="btn btn-primary">Edit</button>
                        <button type="button" className="btn btn-danger">Delete</button>
